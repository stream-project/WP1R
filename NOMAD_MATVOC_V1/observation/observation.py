...
# first file logger
log_one = setup_logger('first_logger', r'C:\Users\GuptaR\Desktop\new_py_scripts\observation\log1.log')


log_two = setup_logger('second_logger', r'C:\Users\GuptaR\Desktop\new_py_scripts\observation\log2.log')
...
#       'upload_id': ['1-QWhnmlQiCVdCHrm2N4Lg'],
#     'calc_id': ['2U094Df3bVPyQSQGc8EyTUh_7QJn']},
#       required={
#         'section_run': {
#             'section_method': '*',
...
# config.client.url = 'http://nomad-lab.eu/prod/rae/api'
# results = client.query_archive(query={
#     'upload_id': ['-6tKmQOSTwe-noXqMyPXBg'],
#     'calc_id': ['DqZEreBU3847aceEkDsoC_n9-84E']})
# print(results)
...
# config.client.url = 'http://nomad-lab.eu/prod/rae/api'
# results = client.query_archive(query={
#     'upload_id': ['-cDNv9yNT4mrMEVcd2YcQA'],
#     'calc_id': ['IVPpzwjW0WMgMiZ7OJMq_0Us8yVe']},
#     required={
#           'section_run': {
#               'section_method': '*',
#               'section_single_configuration_calculation': '*',
...
# un = [] 
if os.path.isfile(r'C:\Users\GuptaR\Desktop\new_py_scripts\observation\un.txt'):
    pass
else:
    with open(r'C:\Users\GuptaR\Desktop\new_py_scripts\observation\un.txt', "wb") as fp:   
        un=[]
        pickle.dump(un, fp)
    
with open(r'C:\Users\GuptaR\Desktop\new_py_scripts\observation\un.txt', "rb") as fp:
    v = pickle.load(fp)
...
for i, result in enumerate(results):
    ...
    if i not in un:
        ...
        if i < length:
            ...
            g.serialize(r'C:\Users\GuptaR\Desktop\new_py_scripts\observation\obser_v1_' + str(i) + '.ttl', format='turtle')
            # print('saved')
