...
response = requests.post('http://vm188067-l3s.hosting.uni-hannover.de:7200/rest/repositories',  files=files)
...
for i_path in dirs:
    ...
    if suff[0] == '.nt':
        ...
        response = requests.post('http://vm188067-l3s.hosting.uni-hannover.de:7200/repositories/Hybrid3/statements', data=rdf.encode('utf-8'), headers = headers)
