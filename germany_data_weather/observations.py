...
for i in range(0,len(station_id)):
    ...
    response = requests.post('http://localhost:7200/repositories/observation/statements', data=open(r'C:\Users\GuptaR\Desktop\repo_all\repo'+str(gr)+'.ttl','r').read(), headers=headers)
    print(response)
